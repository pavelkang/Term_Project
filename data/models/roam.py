...
class World(ShowBase):
    ...
    def loadEnviron(self):
        self.environ = loader.loadModel("secondWorld.egg")
        self.environ.reparentTo(render)
        self.environ.setPos(0,0,0)

    def loadPokemon(self):
        self.pikachu = loader.loadModel("pikachu.egg")
        self.pikachu.reparentTo(render)
        # self.pikachu.setScale(1)
        self.pikachu.setPos(0,0,4)
        # self.pikachu.place()
        self.Groudon = loader.loadModel("Groudon.egg")
        self.Groudon.reparentTo(render)
        self.Groudon.setPos(-50,0,0)
        self.Groudon.showBounds()
        self.a =loader.loadModel("pikachu.egg")
        self.a.reparentTo(render)
        self.a.setPos(self.ralphStartPos[0], self.ralphStartPos[1]-40,
                         self.ralphStartPos[2])
        
        # self.bulbasaur = load_model("bulbasaur.egg")
        # self.bulbasaur.reparentTo(render)
        # self.bulbasaur.setPos(self.ralphStartPos[0], self.ralphStartPos[1],
                         # self.ralphStartPos[2])
        # self.bulbasaur.showBounds()
        # self.bulbasaur.place()
        # self.bulbasaur.setScale(1)
        self.bulbasaur = loader.loadModel("bulbasaur.egg")
	self.bulbasaur.reparentTo(render)
...
#        _FLAME.start(parent=render, renderParent=render)
    ...
    def loadRalph(self):
        ...
        self.ralph = Actor("ralph",{"run":"ralph-run",
                                  "walk":"ralph-walk"})
